...
type SvgComponentProps = Omit<SvgProps, 'fill'> & {
  /**
   * The primary color of the large cog, used for its main part.
   */
  largeCogPrimaryColor: ColorValue;
  /**
   * The secondary color of the large cog, used for its inner part.
   */
  largeCogSecondaryColor: ColorValue;
  /**
   * The primary color of the small cog, used for its main part.
   */
  smallCogPrimaryColor: ColorValue;
  /**
   * The secondary color of the small cog, used for its inner part.
   */
  smallCogSecondaryColor: ColorValue;
};
  ...
  <Svg
    ...
    <G transform="translate(-10.054149,3.8823558)">
      <Path
        ...
        fill={props.largeCogPrimaryColor}
        stroke={props.largeCogPrimaryColor}
      />
      <Path
      ...
      <Circle
        ...
        cy={42}
        r={19.1675}
        fill={props.largeCogSecondaryColor}
        stroke={props.largeCogSecondaryColor}
      />
    </G>
    <G transform="translate(-67.398892,-32.326699)">
      <Path
        ...
        fill={props.smallCogPrimaryColor}
        stroke={props.smallCogPrimaryColor}
      />
      <Path
      ...
      <Circle
        ...
        cy={55.525406}
        r={13.9192}
        fill={props.smallCogSecondaryColor}
        stroke={props.smallCogSecondaryColor}
      />
    </G>
  </Svg>
);
 ...
 */
function CogsIcon({size = 24, colored = false}: IconProps): JSX.Element {
  return (
    <SvgComponent
      height={size}
      width={size}
      stroke="#000000"
      largeCogPrimaryColor={
        colored ? colors.iconPurpleDark : colors.iconGrayscaleDark
      }
      largeCogSecondaryColor={
        colored ? colors.iconPurpleLight : colors.iconGrayscaleLight
      }
      smallCogPrimaryColor={
        colored ? colors.iconGreenDark : colors.iconGrayscaleDark
      }
      smallCogSecondaryColor={
